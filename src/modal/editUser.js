        ...
        <div className="table_content">
          ...
          size="27"/></td>
            ...
            <tr>
              ...
              <td className="no_border"><input type="radio" id="manCheck" name="drone" value="man" checked
          /><label> Nam </label> <input type="radio" id="womanCheck" name="drone" value="woman"
          /><label> Nữ </label></td>
            </tr>
            <tr>
            <td className="no_border">Ngày sinh</td>
              <td className="no_border"><input type="date" id="sinhnhat" name="trip-start" size = "35"
        min="1950-01-01" max="2005-12-31" value="2001-12-03"></input></td>
            </tr>
          </tbody></div>
        </form>
